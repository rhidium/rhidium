        ...
        subcommand
          ...
          .addStringOption((option) =>
            option
              .setName('type')
              .setDescription(
                'The type of output to display, defaults to "Full"',
              )
                ...
                description: stripIndents`
                  Your timezone is ${
                    user.timezone
                      ...
                      : `not set. You can set your timezone using the timezone sub-command: ${await client.manager.commandLink(
                          client,
                          'timestamp',
                          {
                            subcommand: 'timezone',
            ...
            await TimestampCommand.reply(interaction, {
              embeds: [
                Embeds.error({
                  ...
                  description: stripIndents`
                    You have not configured a timezone. Please set a timezone using ${await client.manager.commandLink(
                      client,
                      'timestamp',
                      {
                        subcommand: 'timezone',
                      },
                    )}, or provide a timezone while using the command.
                  `,
                }),
              ],
            });
