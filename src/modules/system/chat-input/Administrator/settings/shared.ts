...
const commandChoicesFromCache = async (
  ...
  const commandData = [
    ...client.commandManager.chatInput.filter((c) =>
      client.commandManager.filterByPermLevel(
        c,
        interaction.member,
        memberPermLevel,
    ...
    ...client.commandManager.userContextMenus.filter((c) =>
      client.commandManager.filterByPermLevel(
        c,
        interaction.member,
        memberPermLevel,
    ...
    ...client.commandManager.messageContextMenus.filter((c) =>
      client.commandManager.filterByPermLevel(
        c,
        interaction.member,
        memberPermLevel,
